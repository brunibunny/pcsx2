...
NetplaySettingsPanelBase::NetplaySettingsPanelBase( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : wxPanel( parent, id, pos, size, style, name )
{
	wxBoxSizer* bSizer2;
	...
	fgSizer3->Add( m_hostPortLabel1, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	m_MCDSyncCheckBox = new wxCheckBox( sbSizer3->GetStaticBox(), wxID_ANY, _("Synchronize With Players"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer5->Add( m_MCDSyncCheckBox, 0, wxALL, 5 );

	m_readOnlyMCDCheckBox = new wxCheckBox( sbSizer3->GetStaticBox(), wxID_ANY, _("Read-only "), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer5->Add( m_readOnlyMCDCheckBox, 0, wxTOP|wxBOTTOM|wxRIGHT, 5 );


	sbSizer3->Add( fgSizer5, 1, wxEXPAND|wxTOP|wxBOTTOM, 5 );


	bSizer121->Add( sbSizer3, 1, wxEXPAND|wxALL, 5 );
...
NetplayLobbyPanelBase::NetplayLobbyPanelBase( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : wxPanel( parent, id, pos, size, style, name )
{
	wxBoxSizer* bSizer10;
